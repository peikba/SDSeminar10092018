...
Export-NAVApplicationObject -DatabaseServer 'localhost' -DatabaseName 'Demo Database NAV (11-0)' -Filter 'Type=Report;Id=205..206' -Path 'c:\temp\Al\Objects.txt' -Username 'Admin' -Password '1<3VScode'
